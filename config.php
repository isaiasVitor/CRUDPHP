...
define('DB_PASSWORD', 'kyzasd39XZ#@');		/** nome do host do MySQL */	
define('DB_HOST', 'localhost');		/** caminho absoluto para a pasta do sistema **/	
if ( !defined('ABSPATH') )		
define('ABSPATH', dirname(__FILE__) . '/');			/** caminho no server para o sistema **/	
if ( !defined('BASEURL') )		
define('BASEURL', '/CRUD\ PHP/');			/** caminho do arquivo de banco de dados **/	
if ( !defined('DBAPI') )		
